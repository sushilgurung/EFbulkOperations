    ...
    public class SqlDataHandlerFactory
    {
        ...
        public static ISqlDataHandler CreateDataHandler(DbContext context)
        {
            try
            {
                ...
                {
                    DatabaseType.SqlServer => "Gurung.EfBulkOperations.SqlServer",
                    DatabaseType.PostgreSql => "Gurung.EfBulkOperations.PostgreSql",
                    _ => throw new NotSupportedException("Unsupported database type")
                };

                string typeName = databaseType switch
                {
                    DatabaseType.SqlServer => "Gurung.EfBulkOperations.SqlDataHandler.SqlServer.SqlServerDataHandler",
                    DatabaseType.PostgreSql => "Gurung.EfBulkOperations.PostgreDataHandler.PostgreSql.PostgreSqlDataHandler",
